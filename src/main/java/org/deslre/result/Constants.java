...
public class Constants {
    ...
    public static final String REDIS_KEY_SYS_SETTING = "deslre:sysSetting:";
    public static final Integer LENGTH_15 = 15;
    public static final Integer LENGTH_10 = 10;
    public static final Long MB = 1024 * 1024L;
    public static final String REDIS_KEY_USER_SPACE_USE = "deslre:user:space:use:";
    ...
    public static final String REDIS_KEY_USER_FILE_TEMP_SIZE = "deslre:user:file:temp";
    ...
    public static final String REDIS_KEY_DOWNLOAD = "deslre:download:";
